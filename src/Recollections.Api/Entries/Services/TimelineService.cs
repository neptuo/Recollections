...
public class TimelineService
{
    ...
    public async Task<(List<TimelineEntryModel> models, bool hasMore)> GetAsync(IQueryable<Entry> query, string userId, ConnectedUsersModel connectedUsers, int? offset)
    {
        if (offset != null)
