    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((context, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string>
            {
                ...
                ["Entries:FreeLimits:EntryCount"] = "20",
                ["Entries:FreeLimits:ImageInEntryCount"] = "20",
                ["Entries:FreeLimits:VideoInEntryCount"] = "20",
                ["Entries:FreeLimits:GpsInEntryCount"] = "20",
                ["Entries:FreeLimits:IsOriginalImageStored"] = "true",
                ["Entries:FreeLimits:StoryCount"] = "20",
                ["Entries:Storage:Images:MaxLength"] = "500000",
                ["Entries:Storage:Images:PremiumMaxLength"] = "5000000",
                ["Entries:Storage:Images:SupportedExtensions:0"] = ".png",
                ["Entries:Storage:Images:SupportedExtensions:1"] = ".jpg",
                ["Entries:Storage:Images:SupportedExtensions:2"] = ".jpeg",
                ["Entries:Storage:Images:SupportedExtensions:3"] = ".gif",
                ["Entries:Storage:Videos:MaxLength"] = "50000000",
                ["Entries:Storage:Videos:SupportedExtensions:0"] = ".mp4",
                ["Entries:Storage:Videos:SupportedExtensions:1"] = ".webm",
